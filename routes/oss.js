...
// POST /api/forge/oss/delete_bucket - deletes object of a given bucket.
router.post("/delete_bucket", async (req, res, next) => {
  try {
...
// POST /api/forge/oss/delete_objects - deletes object of a given bucket.
// Request body must be structured as 'form-data' dictionary
// with the uploaded object id under "fileToUpload" key, and the bucket name under "bucketKey".
router.post("/delete_objects", async (req, res, next) => {
  try {
